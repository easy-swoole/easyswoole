...
class CommandRunner extends Runner
{
    ...
    function run(CallerInterface $caller): ?ResultInterface
    {
        ...
        //配置环境预选处理
        Core::getInstance()->setIsDev((bool)$caller->getParams('produce', true));
        Core::getInstance()->initialize();
        if ($caller->getParams('d') || $caller->getParams('daemonize')) {
            Config::getInstance()->setConf("MAIN_SERVER.SETTING.daemonize", true);
        }
